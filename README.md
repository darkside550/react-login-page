...
This is a simple split screen login page created in react, react-social-login-button and reactstrap for the purpose of learning react. I have given the split screen effect using pure CSS.
